...
Custom hooks allow us to extract component state logic into reusable functions. As an example, we will define a custom hook that manage a movie object state variable. Create the file `src/hooks/useMovie.js` and add this code:
